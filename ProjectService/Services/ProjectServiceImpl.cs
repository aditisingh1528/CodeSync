...
namespace ProjectService.Services
{
    public class ProjectServiceImpl : IProjectService
    {
        ...
        private readonly IProjectDeletedPublisher _publisher;
        ...
        public ProjectServiceImpl(
            ...
            ICacheService           cache,
            IProjectDeletedPublisher publisher)
        {
            _repo      = repo;
            _cache     = cache;
            ...
            GetByIdAsync(int projectId, int userId)
        {
            ...
            if (project.UserId != userId) return (false, "You do not have access to this project.", null);
            ...
            DeleteAsync(int projectId, int userId)
        {
            ...
            if (project.UserId != userId) return (false, "You do not have access to this project.");
            ...
            // Saga step 1: tell FileService and ExecutionService to clean up.
            await _publisher.PublishAsync(new ProjectDeletedEvent
            {
                ProjectId = projectId,
                UserId    = userId,
